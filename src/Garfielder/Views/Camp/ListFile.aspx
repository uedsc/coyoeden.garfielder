	...
	<form id="frmFilter" name="frmFilter" action="" method="post">
		<div class="row tablenav">
			<div class="actions">
				...
				<input type="button" class="btn" value="Filter" id="btnFilter" />
				-->
			</div>
		</div>
		<div class="row">
			<table class="widefat post fixed" cellspacing="0">
				<thead>
					<tr>
						<th scope="col" id="cb" class="manage-column column-cb check-column" ><input id="cbx-toggle-all0" type="checkbox" /></th>
						<th  class="manage-column column-icon" scope="col"></th>										
						<th scope="col" id="title" class="manage-column column-title" >File</th>
				...
				<% item = Model.FileList[i]; %>
					<tr id='md-<%:item.Id %>' class='<%:i%2==0?"alt":"" %> status-publish iedit' valign="top">
						<th scope="row" class="check-column">
							<input type="checkbox" name="ObjIDList" value="<%:item.Id %>" />
						</th>
				...
				<tfoot>
					<tr>
						<th scope="col"  class="manage-column column-cb check-column" ><input id="cbx-toggle-all1" type="checkbox" /></th>
						<th  class="manage-column column-icon" scope="col"></th>
