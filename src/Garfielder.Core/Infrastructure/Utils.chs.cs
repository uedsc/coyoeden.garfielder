...
namespace Garfielder.Core.Infrastructure
{
    public static partial class Utils
    {
        ...
        public static string CHSToPinyin(this string chs, string separator, bool initialCap)
        {
        ...
        /// <param name="separator">连接拼音之间的分隔符</param>
        /// <returns>包含中文字符串的拼音的字符串</returns>
        public static string CHSToPinyin(this string chs, string separator)
        {
        ...
        /// <param name="initialCap">指定是否将首字母大写</param>
        /// <returns>包含中文字符串的拼音的字符串</returns>
        public static string CHSToPinyin(this string chs, bool initialCap)
        {
        ...
        public static string InitialStr(this string txt)
        {
            if (string.IsNullOrEmpty(txt)) return txt;
            var chars = new List<char>();
            txt.ToCharArray().ToList().ForEach(x =>
            {
                chars.AddRange(x.ToString().InitialStrSingle().ToCharArray());
            });
        ...
        /// <returns></returns>
        public static string InitialStrSingle(this string chsStr)
        {
