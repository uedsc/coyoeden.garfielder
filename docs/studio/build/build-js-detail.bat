...
set YUI_BUILD_NAME=studio.detail
...
set CLOSURE_COMPILER=E:\Camp\Works\tools\google-compiler
...
set YUI_FILE_LIST=include\build-js-flist-detail.txt

rem ;; where to put min and debug version of the project
set YUI_FOLDER_DEST=..\js\release
...
if "%YUI_TYPE%"=="js" (
	call include\closure-compiler.bat
)